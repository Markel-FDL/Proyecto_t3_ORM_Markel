...
public class ConsultaProyectosNombre extends javax.swing.JFrame {
    ...
    private void buscarBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarBotonActionPerformed
        if (!Busqueda.getText().trim().equals("")) {
            ArrayList<ProyectosEntity> temp = operaciones.listarProyectosFiltro("nombre", Busqueda.getText());
            if (temp.size() > 0) {
                lproyectos = temp;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaProyectosNombre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaProyectosNombre().setVisible(true);
            }
        });
    }
