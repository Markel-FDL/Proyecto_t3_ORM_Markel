 ...
 * @author iker
 */
public class TablaPiezaProyecto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod Proyecto", "Nombre", "Ciudad", "Nº Piezas", "Cant. suminsitrada", "Nº Proveedores"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaPiezaProyecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaPiezaProyecto().setVisible(true);
            }
        });
    }
